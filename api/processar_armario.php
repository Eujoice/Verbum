...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $url = "https://firestore.googleapis.com/v1/projects/verbum-bd/databases/(default)/documents/armarios/{$num}"
    ...
    $dados = [
        'fields' => [
            ...
            'data_ocupacao'     => ['stringValue'  => date('Y-m-d')],
        ]
    ];
    ...
    if ($code == 200) {
        header("Location: ../pages/armario.php?sucesso=1");
        exit();
    } else {
