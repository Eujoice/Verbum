...
const CONFIG_GENEROS = {
    'Ficção' : { cor: 'linear-gradient(135deg, #7c5cbf, #3eb8a0)', icon: '../assets/imgs/extraterrestrial.png', pattern: 'arcs' },
    'Fantasia': { cor: 'linear-gradient(135deg, #8e44c2, #5e6dd4)', icon: '../assets/imgs/wizard (1).png', pattern: 'stars' },
    'Romance': { cor: 'linear-gradient(135deg, #d95c7a, #f0965a)', icon: '../assets/imgs/relationship.png', pattern: 'dots' },
    'Romance Gótico': { cor: 'linear-gradient(135deg, #d95c7a, #800000)', icon: '../assets/imgs/dracula.png', pattern: 'dots' },
    'Terror': { cor: 'linear-gradient(135deg, #3d2b5e, #1f4068)', icon: '../assets/imgs/scream.png', pattern: 'lines' },
    'Suspense Psicológico': { cor: 'linear-gradient(135deg, #2a6b9c, #6a3a8c)', icon: '../assets/imgs/spider.png', pattern: 'cross' },
    'Literatura Brasileira': { cor: 'linear-gradient(135deg, #1a8c5e, #5ab042)', icon: '../assets/imgs/christ.png', pattern: 'diagonal' },
    'Clássico': { cor: 'linear-gradient(135deg, #c47b2b, #e8b84b)', icon: '../assets/imgs/temple.png', pattern: 'diagonal' },
    'Ficção Científica': { cor: 'linear-gradient(135deg, #7c5cbf, #e8b84b)', icon: '../assets/imgs/robot.png', pattern: 'arcs' },
    'Ficção Distópica': { cor: 'linear-gradient(135deg, #FA8072, #e8b84b)', icon: '../assets/imgs/dystopia.png', pattern: 'arcs' },
    'Não Ficção': { cor: 'linear-gradient(135deg, #a0522d, #c8773e)', icon: '../assets/imgs/parchment.png', pattern: 'cross' },
    'Romance Policial': { cor: 'linear-gradient(135deg, #1a3a5c, #2d6e8e)', icon: '../assets/imgs/private-detective.png', pattern: 'arcs' },
    'Biografia': { cor: 'linear-gradient(135deg, #3d7abf, #56b4d3)', icon: '../assets/imgs/biography.png', pattern: 'lines' },
    'HQ': { cor: 'linear-gradient(135deg, #c04fa0, #e87090)', icon: '../assets/imgs/comic.png', pattern: 'dots' },
    'Tecnologia': { cor: 'linear-gradient(135deg, #2F4F4F, #66c47a)', icon: '../assets/imgs/technology.png', pattern: 'dots' },
    'Autoajuda': { cor: 'linear-gradient(135deg, #2e9e72, #66c47a)', icon: '../assets/imgs/love-yourself (1).png', pattern: 'dots' },
    'Outros': { cor: 'linear-gradient(135deg, #5a7a55, #7aaa6a)', icon: '../assets/imgs/more.png', pattern: 'dots' },
};
        ...
        docs.forEach((doc) => {
            ...
            gridLivros.innerHTML += `
                <div class="livro-card">
                    <a href="/verbum/pages/detalheslivro.php?id=${doc.id}" style="text-decoration: none; color: inherit;">
