document.addEventListener('DOMContentLoaded', () => {
    ...
    let dataPrevistaAtual = ''; // Guarda a data de devolução prevista do empréstimo selecionado
    ...
    document.getElementById('btnRenovar').onclick = function() {
        ...
        if (!idObra) {
            return abrirModal("Aviso", "Selecione um livro para renovar.", false);
        }
        ...
        // Calcula a nova data: 7 dias úteis a partir de hoje
            ...
            async () => {
                ...
                try {
                    ...
                    if (result.sucesso) {
                        ...
                        // Atualiza a data exibida no campo data_fim e recalcula multa zerada
