        ...
        return (
            '<div class="fav-card" data-id="' + fav.id + '">' +
                '<div class="fav-capa-wrap">' +
                    ...
                    '</button>' +
                '</div>' +
                '<a class="fav-info" href="/verbum/pages/detalheslivro.php?id=' + htmlEscape(obra.id || fav.obra_id) + '">' +
...
function exibirVazio(grid) {
    grid.innerHTML =
        '<div class="fav-vazio">' +
            ...
            '<a class="btn-explorar" href="/verbum/pages/acervo.php">Explorar acervo</a>' +
        '</div>';
}
