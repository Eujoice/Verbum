...
<body class="body-acervo">
    ...
    <div class="container-acervo">
        ...
        <!-- ✅ MOVIDO PARA DENTRO DO CONTAINER -->
            ...
            <div class="tabs-container">
                <div class="tabs">
                    <button class="tab ativo" onclick="trocarTab('acervo', this)">
                        Acervo <span class="tab-count" id="count-acervo">—</span>
                    </button>
                    <button class="tab" onclick="trocarTab('emprestimos', this)">
                        Em empréstimo <span class="tab-count" id="count-emprestimos">—</span>
                    </button>
                    <button class="tab" onclick="trocarTab('reservados', this)">
                        Reservados <span class="tab-count" id="count-reservados">—</span>
                    </button>
                    <button class="tab" onclick="trocarTab('historico', this)">
                        Histórico de Empréstimos<span class="tab-count" id="count-historico">0</span>
                    </button>
                </div>
            </div>
