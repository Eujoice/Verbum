...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/styleacervo.css">
...
<body class="body-acervo">
    ...
    <nav class="menu-lateral" id="menuLateral">
        ...
        <div class="sb-nav">
            ...
            <a class="nav-item nav-ativo" href="favoritos.php">
    ...
    <div class="container-acervo">
        ...
        <section class="fav-body">
            ...
            <div class="filtros">
                ...
                <button class="filtro-pill ativo" data-ordem="recente">Mais recentes</button>
                <button class="filtro-pill" data-ordem="titulo">Título A–Z</button>
                <button class="filtro-pill" data-ordem="autor">Autor A–Z</button>
            </div>

            <div class="fav-grid" id="fav-grid">
                <div class="fav-skeleton"></div>
                <div class="fav-skeleton"></div>
                <div class="fav-skeleton"></div>
                <div class="fav-skeleton"></div>
                <div class="fav-skeleton"></div>
