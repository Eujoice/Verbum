...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/armario.css">
...
<div class="container-acervo">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    ...
    <div class="form-container">
        <div class="form-card">
            <form id="formArmario" method="POST" action="../api/processar_armario.php">
...
<form id="formDevolucao" method="POST" action="../api/devolver_armario.php" style="display:none;">
    <input type="hidden" name="numero_armario" id="devolverNum">
</form>

<div id="modalConfirm" class="modal-overlay">
    <div class="modal-content">
        <div class="modal-icon"><img src="../assets/imgs/exclamacao.png" alt="exclamacao"></div>
